...
[![AWS](https://img.shields.io/badge/AWS-Cloud_Engineer-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white)](https://aws.amazon.com)
...
- VPC security groups, NACLs & private networking
- AWS GuardDuty, Security Hub & CloudTrail
- Secrets Manager & KMS encryption
- WAF, Shield & DDoS mitigation strategies
...
- Cost optimization & resource tagging strategies
- AWS Organizations & multi-account strategies
- CloudWatch monitoring & alerting pipelines
...
- Containerization with Docker & ECS/ECR
- Blue-green & canary deployments
- GitOps workflows & pipeline security scanning
...
**🔧 Backend Engineering**
- RESTful API design with Node.js & Python
- Microservices architecture & service mesh
- Event-driven systems with SQS, SNS & Lambda
- Database security — RDS, DynamoDB encryption at rest
...
![GuardDuty](https://img.shields.io/badge/GuardDuty-Threat_Detection-E63946?style=for-the-badge&logo=amazonaws&logoColor=white)
![CloudTrail](https://img.shields.io/badge/CloudTrail-Audit_Logs-8338EC?style=for-the-badge&logo=amazonaws&logoColor=white)
![WAF](https://img.shields.io/badge/WAF-Web_Protection-4361EE?style=for-the-badge&logo=amazonaws&logoColor=white)
![Secrets Manager](https://img.shields.io/badge/Secrets_Manager-Vault-2A9D8F?style=for-the-badge&logo=amazonaws&logoColor=white)
...
├─────────────────────────────────────────────────────────────────┤
│  ✅  Least privilege IAM  →  Zero standing access              │
│  ✅  Encrypt at rest      →  KMS for all sensitive data        │
│  ✅  Encrypt in transit   →  TLS 1.2+ enforced everywhere      │
│  ✅  Audit everything     →  CloudTrail + CloudWatch Logs      │
│  ✅  Shift left security  →  SAST/DAST in CI/CD pipelines      │
│  ✅  Immutable infra      →  No SSH, use SSM Session Manager   │
...
[![trophy](https://github-profile-trophy.vercel.app/?username=moovendhan-v&theme=darkhub&no-frame=true&row=1&column=6&margin-w=8)](https://github.com/ryo-ma/github-profile-trophy)
...
```bash
$ echo "Security isn't a feature. It's a foundation."
Security isn't a feature. It's a foundation.

$ echo "Automate everything. Trust nothing. Verify always."
Automate everything. Trust nothing. Verify always.
```

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1A1A2E,50:FF6B35,100:E63946&height=80&section=footer&animation=fadeIn" width="100%" />

![Profile Views](https://komarev.com/ghpvc/?username=moovendhan-v&color=FF6B35&style=for-the-badge&label=PROFILE+VIEWS)
